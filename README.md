...
**Shuati CLI** 将 "拉题 -> 编码 -> 测试 -> 调试 -> 提交" 的完整工作流搬到了你的本地终端。配合你最喜爱的编辑器（VSCode/Vim/JetBrains），利用本地强大的编译器和调试器，享受飞一般的刷题体验。

### ⚡ 性能对比：本地 vs 在线

| 指标 | ☁️ 在线 OJ (LeetCode等) | 💻 Shuati CLI (本地) | 提升 |
| :--- | :--- | :--- | :--- |
| **编译速度** | 🟥 3~10 秒 | 🟩 **< 0.5 秒** | **20x** 🚀 |
| **测试反馈** | 🟥 需排队等待 | 🟩 **即时反馈** | **即时** ⚡ |
| **调试能力** | 🟧 仅 print 输出 | 🟩 **GDB/LLDB/IDE 断点** | **无限** 🛠️ |
| **数据隐私** | 🟧 代码存云端 | 🟩 **代码全本地** | **安全** 🔒 |
...
<div align="center">
  <sub>Built with ❤️ by Algorithm Lovers for Algorithm Lovers</sub>
</div>
