...
void test_matiji_url_id_extract() {
    assert(MatijiCrawler::extract_problem_id_from_url("https://www.matiji.net/exam/ojquestion/123") == "123");
    assert(MatijiCrawler::extract_problem_id_from_url("https://www.matiji.net/exam/ojquestionlist?qid=456") == "456");
    assert(MatijiCrawler::extract_problem_id_from_url("https://www.matiji.net/exam/ojquestion?questionId=789") == "789");
}
